import{t as e}from"./shaderStore-D-XQlhUT.js";import{$ as t,H as n,V as r,W as i,ct as a,lt as o,n as s,x as c}from"./index-GDLd02NM.js";var l=`firePixelShader`,u=`uniform vEyePosition: vec4f;varying vPositionW: vec3f;
#ifdef VERTEXCOLOR
...
`;e.ShadersStoreWGSL[l]||(e.ShadersStoreWGSL[l]=u);var d=[o,t,i,a,c,n,r,s];for(let t of d)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var f={name:l,shader:u};export{f as firePixelShaderWGSL};
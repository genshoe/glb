import{t as e}from"./shaderStore-D-XQlhUT.js";import{$ as t,Q as n,X as r,ot as i,st as a,tt as o}from"./index-GDLd02NM.js";var s=`gpuRenderParticlesVertexShader`,c=`uniform view: mat4x4f;uniform projection: mat4x4f;uniform translationPivot: vec2f;uniform worldOffset: vec3f;
#ifdef LOCAL
...
`;e.ShadersStoreWGSL[s]||(e.ShadersStoreWGSL[s]=c);var l=[a,o,t,i,n,r];for(let t of l)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var u={name:s,shader:c};export{u as gpuRenderParticlesVertexShaderWGSL};
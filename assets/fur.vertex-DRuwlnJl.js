import{t as e}from"./shaderStore-D-XQlhUT.js";import{$ as t,At as n,C as r,Ct as i,Et as a,Q as o,St as s,X as c,Z as l,et as u,i as d,kt as f,ot as p,st as m,tt as h,xt as g}from"./index-mFGISFSZ.js";var _=`furVertexShader`,v=`attribute position: vec3f;attribute normal: vec3f;
#ifdef UV1
attribute uv: vec2f;
#endif
#ifdef UV2
...
`;e.ShadersStoreWGSL[_]||(e.ShadersStoreWGSL[_]=v);var y=[n,f,a,m,t,h,d,u,i,s,g,p,c,o,l,r];for(let t of y)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var b={name:_,shader:v};export{b as furVertexShaderWGSL};
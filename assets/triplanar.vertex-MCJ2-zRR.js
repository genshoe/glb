import{t as e}from"./shaderStore-D-XQlhUT.js";import{$ as t,At as n,C as r,Ct as i,Et as a,Q as o,St as s,X as c,Z as l,et as u,i as d,kt as f,ot as p,st as m,tt as h,ut as g,xt as _}from"./index-GDLd02NM.js";var v=`triplanarVertexShader`,y=`attribute position: vec3f;
#ifdef NORMAL
...
`;e.ShadersStoreWGSL[v]||(e.ShadersStoreWGSL[v]=y);var b=[g,n,f,a,m,t,h,d,u,i,s,_,p,c,o,l,r];for(let t of b)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var x={name:v,shader:y};export{x as triplanarVertexShaderWGSL};
import{t as e}from"./shaderStore-D-XQlhUT.js";import{$ as t,G as n,H as r,J as i,K as a,U as o,V as s,W as c,Y as l,ct as u,lt as d,q as f,ut as p}from"./index-mFGISFSZ.js";var m=`waterPixelShader`,h=`uniform vEyePosition: vec4f;uniform vDiffuseColor: vec4f;
#ifdef SPECULARTERM
...
`;e.ShadersStoreWGSL[m]||(e.ShadersStoreWGSL[m]=h);var g=[p,l,n,i,f,a,d,t,c,u,o,r,s];for(let t of g)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var _={name:m,shader:h};export{_ as waterPixelShaderWGSL};
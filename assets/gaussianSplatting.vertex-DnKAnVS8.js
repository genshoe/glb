import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./sceneUboDeclaration-B96Tfx7b.js";import{t as n}from"./meshUboDeclaration-BATNZvmb.js";import{$ as r,Q as i,X as a,f as o,ot as s,st as c,tt as l,ut as u}from"./index-GDLd02NM.js";var d=`gaussianSplattingVertexShader`,f=`#include<sceneUboDeclaration>
...
`;e.ShadersStoreWGSL[d]||(e.ShadersStoreWGSL[d]=f);var p=[t,n,u,c,l,r,o,s,i,a];for(let t of p)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var m={name:d,shader:f};export{m as gaussianSplattingVertexShaderWGSL};
import{t as e}from"./shaderStore-D-XQlhUT.js";import{D as t,E as n,M as r,N as i,O as a,P as o,ht as s,j as c,k as l,mt as u,pt as d,r as f,y as p,z as m}from"./index-mFGISFSZ.js";var h=`terrainPixelShader`,g=`precision highp float;uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;
#ifdef SPECULARTERM
...
`;e.ShadersStore[h]||(e.ShadersStore[h]=g);var _=[s,o,i,r,c,u,m,l,d,p,a,t,n,f];for(let t of _)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var v={name:h,shader:g};export{v as terrainPixelShader};
import{t as e}from"./shaderStore-D-XQlhUT.js";import{$ as t,H as n,J as r,K as i,U as a,V as o,W as s,ct as c,lt as l,n as u,q as d,ut as f,x as p}from"./index-GDLd02NM.js";var m=`terrainPixelShader`,h=`uniform vEyePosition: vec4f;uniform vDiffuseColor: vec4f;
#ifdef SPECULARTERM
...
`;e.ShadersStoreWGSL[m]||(e.ShadersStoreWGSL[m]=h);var g=[f,r,d,i,l,t,s,c,p,a,n,o,u];for(let t of g)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var _={name:m,shader:h};export{_ as terrainPixelShaderWGSL};
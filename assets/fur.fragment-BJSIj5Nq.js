import{t as e}from"./shaderStore-D-XQlhUT.js";import{$ as t,H as n,J as r,K as i,U as a,V as o,W as s,ct as c,lt as l,n as u,q as d,ut as f,x as p}from"./index-GDLd02NM.js";var m=`furPixelShader`,h=`uniform vEyePosition: vec4f;uniform vDiffuseColor: vec4f;uniform furColor: vec4f;uniform furLength: f32;varying vPositionW: vec3f;varying vfur_length: f32;
#ifdef NORMAL
...
`;e.ShadersStoreWGSL[m]||(e.ShadersStoreWGSL[m]=h);var g=[f,r,t,d,i,s,l,c,p,a,n,o,u];for(let t of g)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var _={name:m,shader:h};export{_ as furPixelShaderWGSL};
import{t as e}from"./shaderStore-D-XQlhUT.js";import{$ as t,At as n,C as r,Ct as i,Et as a,Q as o,St as s,X as c,Z as l,et as u,i as d,kt as f,ot as p,st as m,tt as h,xt as g}from"./index-GDLd02NM.js";var _=`waterVertexShader`,v=`attribute position: vec3f;
#ifdef NORMAL
...
`;e.ShadersStoreWGSL[_]||(e.ShadersStoreWGSL[_]=v);var y=[n,f,a,m,h,d,u,t,i,s,g,p,o,l,r,c];for(let t of y)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var b={name:_,shader:v};export{b as waterVertexShaderWGSL};
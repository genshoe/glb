import{t as e}from"./shaderStore-D-XQlhUT.js";import{D as t,E as n,k as r,mt as i,pt as a,r as o,z as s}from"./index-mFGISFSZ.js";var c=`gridPixelShader`,l=`#extension GL_OES_standard_derivatives : enable
...
`;e.ShadersStore[c]||(e.ShadersStore[c]=l);var u=[i,s,r,a,n,t,o];for(let t of u)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var d={name:c,shader:l};export{d as gridPixelShader};